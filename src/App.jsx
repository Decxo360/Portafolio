...
function App() {
  ...
  return (
    <div>
      ...
      <div className='bg-slate-900 h-[200px]' ref={redesSosciales}>
        <RedesSociales/>
      </div>
      <Footer/>
    </div>
