...
export const CardComponent = ({titulo,etiquetas,descripcion,url,codigo}) => {
  return (
    <div className='flex flex-col w-[500px] mt-8   ml-10 mr-10 bg-slate-800 rounded-md hover:shadow-lg hover:shadow-blue-500/50 animate__animated animate__slideInLeft'>
        ...
        <h1 className='flex justify-center items-center text-[40px] text-white '>{titulo}</h1>
            ...
            <div className='absolute bottom-5 left-[40%] text-white h-[50px]' >
                <button className='mt-5 bg-indigo-800 rounded-md h-[35px] w-[100px] hover:scale-125 ease-in-out duration-100 delay-150 hover:bg-indigo-500 '><a href={codigo}>Ver código</a></button>
            </div>
        </div>
    </div>
  )
