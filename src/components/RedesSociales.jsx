  ...
  return (
    <div className='flex flex-col justify-center items-center'>
        ...
        <div className='flex flex-col justify-around items-center mt-7 w-[100%] 2xl:flex-row xl:flex-row lg:flex-row md:flex-row sm:flex-row'>
          <div className='mt-3 mb-5 flex flex-col rounded-2xl justify-center items-center w-[150px] h-[150px] shadow-2xl shadow-zinc-600 hover:cursor-pointer hover:shadow-blue-700 ' onClick={pressClick}>
            <TooltipComponent>
              <Gmail/>
